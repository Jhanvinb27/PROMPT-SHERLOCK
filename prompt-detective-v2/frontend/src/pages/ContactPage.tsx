...
const ContactPage: React.FC = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-white via-slate-50 to-slate-100 py-16">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        <header className="text-center max-w-3xl mx-auto">
          <span className="inline-flex items-center rounded-full bg-blue-50 px-4 py-1 text-xs font-semibold uppercase tracking-wide text-blue-600">
            Support Centre
          </span>
        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          <section className="rounded-2xl bg-white shadow-xl shadow-slate-200/60 ring-1 ring-slate-200">
            ...
            <form onSubmit={handleSubmit} className="px-6 py-6 space-y-6">
              <div className="grid gap-6 sm:grid-cols-2">
                <label className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    required
                    className="rounded-lg border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200"
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                ...
                <label className="flex flex-col gap-2">
                  <span className="text-sm font-medium text-slate-700">Where are you in your journey?</span>
                  <select
              ...
              <label className="flex flex-col gap-2">
                ...
                <textarea
                  ...
                  rows={6}
                  maxLength={2000}
                  className="w-full rounded-lg border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200"
              ...
              <label className="flex items-start gap-3 rounded-lg border border-slate-200 bg-slate-50 px-4 py-4">
                ...
                <span className="text-sm text-slate-600">
                  ...
                  <a href="/privacy" className="font-medium text-blue-600 hover:text-blue-700" target="_blank" rel="noreferrer">
                    privacy policy
                  </a>
                  .
                </span>
              ...
              <div className="flex items-center justify-between border-t border-slate-200 pt-6">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="inline-flex items-center rounded-lg bg-blue-600 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-blue-600/30 transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:bg-blue-400"
                >
            ...
            <div className="rounded-2xl bg-slate-900 p-8 text-slate-100 shadow-xl shadow-slate-900/40">
              ...
              <div className="mt-6 space-y-4 text-sm">
                ...
                <div>
                  ...
                  <p className="mt-1 text-base">Bengaluru, India</p>
                  <p className="text-sm text-slate-400">Prompt Detective Labs Private Limited</p>
                </div>
              </div>
            </div>

            <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-lg shadow-slate-200/50">
              <h3 className="text-lg font-semibold text-slate-900">Service-level commitments</h3>
              <ul className="mt-4 space-y-3 text-sm text-slate-600">
                <li className="flex items-start gap-3">
                  <span className="mt-1 inline-flex h-2.5 w-2.5 rounded-full bg-emerald-500"></span>
                  <span>
                    <strong className="text-slate-800">General enquiries:</strong> 12 business hours response, follow-up until closure.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-1 inline-flex h-2.5 w-2.5 rounded-full bg-amber-500"></span>
                  <span>
                    <strong className="text-slate-800">Billing or integration issues:</strong> 8 business hours triage, real-time escalation if revenue-impacting.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-1 inline-flex h-2.5 w-2.5 rounded-full bg-rose-500"></span>
                  <span>
                    <strong className="text-slate-800">Security disclosures:</strong> 4 hour acknowledgment, coordinated remediation with our security team.
                  </span>
                </li>
              </ul>
